...
Measures of complexity (from the original work)
...
![schooling levels vs 3k-bins](assets/grades vs ranks.png){ align=left }
/// caption
**schooling levels vs 3k-bins**
/// 

Words in the list (grouped in 3k words bins) compared with school levels
...
![morphology vs semantics](assets/morphology vs semantics.png){ align=left }
/// caption
**morphology vs semantics**
///

![number of words in dictionaries](assets/number of words in dictionaries.png){ align=left }
/// caption
